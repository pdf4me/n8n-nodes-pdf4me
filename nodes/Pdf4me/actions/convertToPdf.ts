...
export const description: INodeProperties[] = [
...

	{
		...
		hint: 'Convert file to PDF. See our <b><a href="https://docs.pdf4me.com/integration/n8n/convert/convert-to-pdf/" target="_blank">complete guide</a></b> for detailed instructions and examples.',
	},
	{
...
export async function execute(this: IExecuteFunctions, index: number) {
	...
	try {
		...
		if (errorObj.statusCode === 500) {
				...
				`| Debug: inputDataType=${inputDataType}, docName=${docName}`, { itemIndex: index });
		}
