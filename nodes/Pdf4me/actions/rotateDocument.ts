...
export const description: INodeProperties[] = [
	...
	},
	{
		...
		hint: 'Rotate document. See our <b><a href="https://docs.pdf4me.com/integration/n8n/organize/rotate-document/" target="_blank">complete guide</a></b> for detailed instructions and examples.',
	},
	{
...
export async function execute(this: IExecuteFunctions, index: number) {
	...
	if (inputDataType === 'binaryData') {
		...
		// Returns blobId which is then used in Rotate API payload
	...
	try {
		...
		if (errorObj.statusCode === 500) {
				...
				`| Debug: inputDataType=${inputDataType}, docName=${finalDocName}`, { itemIndex: index });
		}
