...
export const description: INodeProperties[] = [
	{
		...
		required: true,
		default: 'binaryData',
		description: 'Choose how to provide the PDF file to delete unwanted pages from',
		displayOptions: {
			show: {
	...
	},
	{
		...
		required: true,
		default: '',
		description: 'URL to the PDF file to delete unwanted pages from',
	...
	},
	{
		...
		hint: 'Delete unwanted pages from PDF. See our <b><a href="https://docs.pdf4me.com/integration/n8n/organize/delete-unwanted-pages-from-pdf/" target="_blank">complete guide</a></b> for detailed instructions and examples.',
	},
	{
		...
		required: true,
		default: '',
		description: 'Page numbers to delete (e.g. "2" or "1,3,5" or "2-4")',
		displayOptions: {
			show: {
				operation: [ActionConstants.DeleteUnwantedPagesFromPdf],
			},
...
export async function execute(this: IExecuteFunctions, index: number) {
	...
	const responseData = await pdf4meAsyncRequest.call(this, '/api/v2/DeletePages', body);
