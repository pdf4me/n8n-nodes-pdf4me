			...
			},
{
	...
	},
	{
		...
		hint: 'Add barcodes to your PDF. See our <b><a href="https://docs.pdf4me.com/integration/n8n/barcode/add-barcode-to-pdf/" target="_blank">complete guide</a></b> for detailed instructions and examples.',
...
{ name: 'None', value: '', description: 'No text display' },
	...
	},
	{
		...
		required: true,
		default: false,
		description: 'Whether to select "true" to hide the text of the Barcode and "false" to display it alongside the Barcode',
		displayOptions: {
			show: {
				operation: [ActionConstants.AddBarcodeToPdf],
			},
	...
	},
	{
		...
		required: true,
		default: false,
		description: 'Whether to if you want to Show Only In Print, Show only in print. You can choose these two options.',
		displayOptions: {
			show: {
				operation: [ActionConstants.AddBarcodeToPdf],
			},
	...
	},
	{
		...
		required: true,
		default: false,
		description: 'Whether to if you want to Is Text Above text. You can choose these two options.',
		displayOptions: {
			show: {
				operation: [ActionConstants.AddBarcodeToPdf],
			},
