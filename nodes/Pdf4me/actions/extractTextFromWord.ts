...
export const description: INodeProperties[] = [
	...
	},
	{
		...
		hint: 'Extract text from Word document. See our <b><a href="https://docs.pdf4me.com/integration/n8n/extract/extract-text-from-word/" target="_blank">complete guide</a></b> for detailed instructions and examples.',
	},
	{
	...
	if (responseData) {
		...
		try {
			parsedJson = JSON.parse(jsonString);
						...
						throw new NodeOperationError(this.getNode(), 'Response is not valid JSON', { itemIndex: index });
		}
