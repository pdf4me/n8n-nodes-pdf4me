...
export const description: INodeProperties[] = [
	...
	},
	{
		...
		hint: 'Sign PDF. See our <b><a href="https://docs.pdf4me.com/integration/n8n/edit/sign-pdf/" target="_blank">complete guide</a></b> for detailed instructions and examples.',
	},
	{
	...
	if (signatureImageInputType === 'binaryData') {
		...
		try {
			new URL(signatureImageUrl);
						...
						throw new NodeOperationError(this.getNode(), 'Invalid URL format. Please provide a valid URL to the signature image file.', { itemIndex: index });
		}
