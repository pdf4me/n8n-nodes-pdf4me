...
export const description: INodeProperties[] = [
	{
		...
		required: true,
		default: 'binaryData',
		description: 'Choose how to provide the image file to rotate',
		displayOptions: {
			show: {
	...
	},
	{
		...
		required: true,
		default: '',
		description: 'URL to the image file to rotate',
	...
	},
	{
		...
		name: 'outputFileName',
		type: 'string',
		default: 'rotate_image_output.png',
		...
		hint: 'Rotate image. See our <b><a href="https://docs.pdf4me.com/integration/n8n/image/rotate-image/" target="_blank">complete guide</a></b> for detailed instructions and examples.',
	},
	{
...
export async function execute(this: IExecuteFunctions, index: number) {
	...
	const result: any = await pdf4meAsyncRequest.call(this, '/api/v2/RotateImage', body);
